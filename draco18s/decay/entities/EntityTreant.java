...
public class EntityTreant extends EntityGolem
{
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
        ...
        boolean flag = par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), 10);
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (int l = 0; l < k; ++l)
        {
            this.dropItem(Block.wood.blockID, 1);
        }
    }
