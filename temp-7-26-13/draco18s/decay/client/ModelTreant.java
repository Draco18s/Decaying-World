...
public class ModelTreant extends ModelBase
{
	...
	public ModelTreant(float par1)
	{
		this(par1, -7.0F);
	}

	public ModelTreant(float par1, float par2)
	{
		short short1 = 128;
		short short2 = 128;
	 ...
	 */
	 ...
	 {
		 EntityTreant entityTreant = (EntityTreant)par1EntityLiving;
